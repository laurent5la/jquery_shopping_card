...
<div class="billingform-div">
    ...
    <input type="hidden" name="locale" value="en">
		...
		<div id="billingform__input--div" class="form-group">
			<input type="text" id="bill_to_address_line1"name="bill_to_address_line1" placeholder="Address Line 1" class="form-control"/>
		</div>
		<div id="billingform__input--div" class="form-group">
			<input type="text" id="bill_to_address_line2" name="bill_to_address_line2" placeholder="Address Line 2" class="form-control"/>
		</div>
		<div id="billingform__input--div" class="form-group">
			<input type="text" id="bill_to_address_city" name="bill_to_address_city" placeholder="City" class="form-control"/>
		</div>
		<div id="billingform__input--div" class="form-group">
			<select id="bill_to_address_state" name="bill_to_address_state" class="form-control bfh-states" data-country="bill_to_address_country"></select>
		</div>
		<div id="billingform__input--div" class="form-group">
			<input type="text" id='bill_to_address_postal_code' name="bill_to_address_postal_code" placeholder="Zipcode" class="form-control"/>
		</div>
		<div id="billingform__input--div" class="form-group">
			<select id="bill_to_address_country" name="bill_to_address_country" class="form-control bfh-countries" data-country="US"></select>
		</div>
		<div id="billingform__input--div" class="form-group">
			<input type="text" id="phone_number" name="bill_to_phone" placeholder="Phone Number" class="form-control bfh-phone" data-format="+1 (ddd) ddd-dddd"/>
		</div>
	</form>
</div>
