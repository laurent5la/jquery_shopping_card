<div id="personalinfoform-div" class="personalinfoform-div">
    ...
    <div class="checkbox personalinfoform__input--div">
        <label><input type="checkbox" name="sameBillingAddressCheckbox" id="addressSame" value="addressSame" class="">Billing address is same as personal address</label><br>
    </div>
