...
<div id = "content">
    ...
    <ul class="nav nav-tabs options">
      <li><a class="product_details bir-links" data-toggle="pill" href="#details">Product Details</a></li>
      <li><a class="whats_included bir-links" data-toggle="pill" href="#included">What's Included</a></li>
      <li><a class="compare_products bir-links" data-toggle="pill" href="#compare_card">Compare Products</a></li>
    </ul>
    ...
    <div class="tab-content">
      ...
      <div id="compare_card" class="tab-pane fade">
        @include('partials.compare_products')
      </div>
